...
export function mockAnswerBody(q) {
	switch (q.type) {
		...
		case COMPONENT_TYPES.MANAGE_LIST: {
			...
			return {
				[q.fieldName]: [
					{ id: '1234', travelCompanionName: 'Companion 1', travelCompanionEmail: 'compaion-1@example.com' },
					{ id: '4567', travelCompanionName: 'Companion 2', travelCompanionEmail: 'compaion-2@example.com' },
					{ id: '8901', travelCompanionName: 'Companion 3', travelCompanionEmail: 'compaion-3@example.com' }
				]
			};
		}
		default:
