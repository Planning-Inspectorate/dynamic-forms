...
export class Question {
     ...
     */
    constructor({ title, question, viewFolder, fieldName, url, pageTitle, description, validators, html, hint, interfaceType, shouldDisplay, autocomplete, editable, actionLink, viewData }: any, methodOverrides?: Record<string, Function>);
     ...
     */
    prepQuestionForRendering(section: Section, journey: Journey, customViewData?: Record<string, unknown>, payload?: unknown): QuestionViewModel;
    /**
     ...
     */
    getDataToSave(req: any, journeyResponse: JourneyResponse): Promise<{
     ...
     * }>}
     */
    formatAnswerForSummary(sectionSegment: string, journey: Journey, answer: any, capitals?: boolean): Array<{
        key: string;
        value: string | any;
        action: {
            href: string;
