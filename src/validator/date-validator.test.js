...
describe('./src/dynamic-forms/validator/date-validator.js', () => {
	describe('validator', () => {
		...
		it('passes validation if allowEmpty is true and no fields are provided (undefined)', async () => {
			const req = {
				body: {
					['date-question_day']: undefined,
					['date-question_month']: undefined,
		...
		it('passes validation if allowEmpty is true and fields are empty strings', async () => {
			const req = {
				body: {
					['date-question_day']: '',
					['date-question_month']: '',
		...
		it('throws error if allowEmpty is true but date is partially filled (missing day)', async () => {
			const req = {
				body: {
					['date-question_day']: '',
					['date-question_month']: '10',
		...
		it('throws error if allowEmpty is true but invalid values are provided', async () => {
			const req = {
				body: {
