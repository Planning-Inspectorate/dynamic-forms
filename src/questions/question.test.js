...
describe('./src/dynamic-forms/question.js', () => {
	...
	describe('saveAction', () => {
		it('should handle validation errors', async () => {
			...
			const question = getTestQuestion();
			question.checkForValidationErrors = mock.fn(() => expectedErrors);
		...
		it('should handle saving errors', async () => {
			...
			const question = getTestQuestion();
			question.checkForValidationErrors = mock.fn();
			question.getDataToSave = mock.fn();
			question.checkForSavingErrors = mock.fn(() => expectedErrors);
		...
		it('should handle saving', async () => {
			...
			question.checkForValidationErrors = mock.fn();
			question.getDataToSave = mock.fn();
			question.checkForSavingErrors = mock.fn();
			const res = {
				redirect: mock.fn()
			};
			const req = {};
			...
			class TestJourney {
				response = {};
				getNextQuestionUrl = mock.fn(() => expectedUrl);
			}
